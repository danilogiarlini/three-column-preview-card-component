    ...
    <>
      <main>
        <div className="component">
          <div className="vehicle-card accent-1">
            <div className="grid-flow">
              ...
              <h1 className="vehicle-type">Sedans</h1>
              <p className="vehicle-description">
                Choose a sedan for its affordability and excellent fuel economy.
                Ideal for cruising in the city or on your next road trip.
              </p>
            </div>
            <button className="accent-1">Learn More</button>
          </div>
          <div className="vehicle-card accent-2">
            <div className="grid-flow">
              <svg width="64" height="40" xmlns="http://www.w3.org/2000/svg">
                <g fill="none" fill-rule="evenodd">
                  <circle fill="#000" opacity=".201" cx="20" cy="20" r="20" />
              ...
              <h1 className="vehicle-type">SUVs</h1>
              <p className="vehicle-description">
                Take an SUV for its spacious interior, power, and versatility.
                Perfect for your next family vacation and off-road adventures.
              </p>
            </div>
            <button className="accent-2">Learn More</button>
          </div>
          <div className="vehicle-card accent-3">
            <div className="grid-flow">
              <svg width="64" height="40" xmlns="http://www.w3.org/2000/svg">
                <g fill="none" fill-rule="evenodd">
                  <circle fill="#000" opacity=".201" cx="20" cy="20" r="20" />
              ...
              <h1 className="vehicle-type">Luxury</h1>
              <p className="vehicle-description">
                Cruise in the best car brands without the bloated prices. Enjoy
                the enhanced comfort of a luxury rental and arrive in style.
              </p>
            </div>
            <button className="accent-3">Learn More</button>
          </div>
        </div>
      </main>
    </>
